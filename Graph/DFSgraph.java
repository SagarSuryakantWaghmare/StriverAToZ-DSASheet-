...
public class DFSgraph {
    ...
    // After in the both the position we have to check if the node is already visited or not
    // If not then we have to mark it as visited and add it to the list
    // Then we have to go for the next node in the adjacency list of the current node
    // If the node is already visited then we have to skip it and go for the next node in the adjacency list of the current node
    // We have to do this for all the nodes in the adjacency list of the current node
